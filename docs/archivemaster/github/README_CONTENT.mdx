...
Este proyecto está licenciado bajo la licencia MIT - ver el archivo [LICENSE](https://github.com/korozcolt/archive-master-app/blob/main/LICENSE) para más detalles.
