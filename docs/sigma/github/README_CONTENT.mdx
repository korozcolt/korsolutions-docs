...
|-----------|-------------|
| ****PROGRESO.md**** | 📊 Tracking diario, estadísticas, próximos pasos |
| ****CLAUDE.md**** | 🤖 Guidelines de desarrollo y mejores prácticas |
| ****docs/DECISIONES.md**** | 📋 Architecture Decision Records (ADR) |
...
1. Leer **CLAUDE.md** para guidelines
...
Para preguntas o issues, consultar la documentación en `/docs` o revisar **PROGRESO.md** para estado actual.
